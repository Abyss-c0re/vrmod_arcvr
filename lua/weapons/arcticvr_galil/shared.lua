...
SWEP.FingerAngles = {
    ...
    Angle(0,-20.6,0), Angle(0,-60,0), Angle(0,-47,0), --finger 2
    Angle(0,-20.8,0), Angle(0,-40,0), Angle(0, -60.1,0), --finger 3
    Angle(0,-20.3,-8.2), Angle(0,-40,0), Angle(0,-30.5,0), --finger 4
    --right hand closed angles
    Angle(-0,-7,-5), Angle(0,40,0), Angle(0,10,0), --finger 0
    Angle(-2,25,17), Angle(0,-10,0), Angle(0,-35.9,0), --finger 1   This is the index finger, on the trigger
    Angle(0,-20.6,0), Angle(0,-60,0), Angle(0,-47,0), --finger 2
    Angle(0,-20.8,0), Angle(0,-40,0), Angle(0, -60.1,0), --finger 3
    Angle(0,-20.3,-8.2), Angle(0,-40,0), Angle(0,-30.5,0), --finger 4
}
