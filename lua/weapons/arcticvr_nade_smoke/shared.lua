...
SWEP.ViewModel = "models/weapons/arcticvr/nade_smoke.mdl" -- I mean, you probably have to edit these too
...
SWEP.PrintName = "VR Smoke Grenade" -- you should probably change this
...
SWEP.ShootEntity = "arcticvr_nade_smoke_t" -- set to thrown grenade entity
SWEP.PinModel = "models/weapons/arcticvr/nade_smoke_pin.mdl" -- set to released pin
SWEP.SpoonModel = "models/weapons/arcticvr/nade_smoke_spoon.mdl" -- set to released spoon

SWEP.ThrowSpeedMult = 100

g_VR.viewModelInfo = g_VR.viewModelInfo or {}

g_VR.viewModelInfo.arcticvr_nade_smoke = {
