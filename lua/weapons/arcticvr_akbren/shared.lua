...
SWEP.ViewModel = "models/weapons/arcticvr/lmg_akbren.mdl"
SWEP.WorldModel = "models/weapons/arcticvr/w_akbren.mdl"
SWEP.ArcticVR = true
...
if CLIENT then
    ...
    g_VR.viewModelInfo.arcticvr_akbren = {
    ...
    SWEP.ForegripOffset = Vector(16, -4, 0)
