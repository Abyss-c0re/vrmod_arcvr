...
if CLIENT then
    ...
    SWEP.FingerAngles = {
        ...
        Angle(0, 40, 0),
        Angle(0, 10, 0),
        Angle(-5, 35, 10), --finger 1   This is the index finger, off the trigger
        Angle(0, 5, 0),
        Angle(0, -7.9, 0),
        Angle(-10, 10.6, 0), --finger 2
        Angle(0, -60, 0),
        Angle(0, -47, 0),
        ...
        Angle(-5, -7, -5), --finger 0
        Angle(0, 40, 0),
        Angle(0, 10, 0),
        Angle(-5, 35, 17), --finger 1   This is the index finger, on the trigger
        Angle(0, -5, 0),
        Angle(0, -25.9, 0),
        Angle(-10, 10.6, 0), --finger 2
        Angle(0, -60, 0),
