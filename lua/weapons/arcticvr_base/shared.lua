...
SWEP.NetworkedSounds = {"FireSound", "FireSoundSil", "DryFireSound", "SwitchModeSound", "SlidePulledSound", "SlideBackSound", "SlideForwardSound", "SlideReleaseSound", "BoltUpSound", "MagInSound", "MagOutSound", "DirectChamberSound", "OpenChamberSound", "CloseChamberSound", "MeleeStrikeSound", "MeleeHitSound", "SlideClickLockSound", "BeltPullSound", "BeltInSound", "BeltOutSound",}
...
if SERVER then include("sv_server.lua") end
...
if CLIENT then
    ...
    g_VR.viewModelInfo.arcticvr_m9 = {
        -- this needs to be g_VR.viewModelInfo.your_gun_name
    ...
    SWEP.FingerAngles = {
        ...
        Angle(-25, -6.9, -20.1), --finger 0
        Angle(0, 0, 0),
        Angle(0, 60, 0),
        Angle(10, 25, 15), --finger 1
        Angle(0, -50, 0),
        Angle(0, -47.9, 0),
        Angle(0, -33.6, 0), --finger 2
        Angle(0, -60, 0),
        Angle(0, -27, 0),
        Angle(0, -35.8, 0), --finger 3
        Angle(0, -40.6, 0),
        Angle(0, -45.1, 0),
        Angle(0, -32.3, -8.2), --finger 4
        Angle(0, -34.4, 0),
        Angle(0, -22.5, 0),
    ...
    SWEP.LeftHandFingerAngles = {
        ...
        Angle(0, -40, 0),
        Angle(0, 0, 0),
        Angle(0, -10, 0), --finger 1
        Angle(0, -10, 0),
        Angle(0, 0, 0),
        Angle(0, -10, 0), --finger 2
        Angle(0, -10, 0),
        Angle(0, 0, 0),
        Angle(0, -10, 0), --finger 3
        Angle(0, -10, 0),
        Angle(0, 0, 0),
        Angle(0, -10, 0), --finger 4
        Angle(0, -10, 0),
        Angle(0, 0, 0),
        -- closed
        Angle(30, 0, 0),
    ...
    SWEP.CHandleRaisedOffset = {
        -- offset for the charging handle in the "up" position if it can be raised.
...
function SWEP:Cycle(blank)
    ...
    if CLIENT then
        ...
        if not self.OpenBolt and msbf ~= 0 and 1 / msbf > math.Rand(0, 1) then
            -- JAM
            return
        end
    ...
    if self.OpenBolt or self.ShootStraightFromMag then
        if self.LoadedRounds > 0 then self.LoadedRounds = self.LoadedRounds - 1 end
    else
