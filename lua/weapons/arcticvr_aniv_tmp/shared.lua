...
if CLIENT then
    ...
    SWEP.FingerAngles = {
        ...
        Angle(0, 5, 0),
        Angle(0, -7.9, 0),
        Angle(0, -10.6, 0), --finger 2
        Angle(0, -60, 0),
        Angle(0, -47, 0),
        Angle(0, -10.8, 0), --finger 3
        Angle(0, -40, 0),
        Angle(0, -60.1, 0),
        Angle(0, -10.3, -8.2), --finger 4
        Angle(0, -40, 0),
        Angle(0, -30.5, 0),
        ...
        Angle(0, 40, 0),
        Angle(0, 10, 0),
        Angle(0, 25, 17), --finger 1   This is the index finger, on the trigger
        Angle(0, -5, 0),
        Angle(0, -50.9, 0),
        Angle(0, -10.6, 0), --finger 2
        Angle(0, -60, 0),
    ...
    SWEP.FireSelectPoses = {
        ...
        [2] = {
            selector = {
                pos = Vector(-0.088, 0, 0),
                ang = Angle(0, 0, 0)
            }
        },
        [1] = {
            selector = {
                pos = Vector(-0.171, 0, 0),
                ang = Angle(0, 0, 0)
            }
        }
    }
