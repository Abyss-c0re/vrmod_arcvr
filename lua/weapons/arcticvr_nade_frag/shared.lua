...
SWEP.PrintName = "VR Frag Grenade" -- you should probably change this
SWEP.Slot = 5 -- you could edit these if you like
SWEP.SlotPos = 1
SWEP.DrawAmmo = false -- irrelevant
SWEP.DrawCrosshair = false
SWEP.ViewModelFOV = 90 -- ALWAYS set to 90
SWEP.ShootEntity = "arcticvr_nade_frag_t" -- set to thrown grenade entity
SWEP.PinModel = "models/weapons/arcticvr/nade_frag_pin.mdl" -- set to released pin
SWEP.SpoonModel = "models/weapons/arcticvr/nade_frag_spoon.mdl" -- set to released spoon
SWEP.ThrowSpeedMult = 100
g_VR.viewModelInfo = g_VR.viewModelInfo or {}
g_VR.viewModelInfo.arcticvr_nade_frag = {
