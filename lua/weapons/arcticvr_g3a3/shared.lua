...
SWEP.ViewModel = "models/weapons/arcticvr/rif_g3a3.mdl"
SWEP.WorldModel = "models/weapons/arcticvr/w_g3a3.mdl"
...
g_VR.viewModelInfo.arcticvr_g3a3 = {
...
SWEP.FireSelectPoses = {
    ...
    [1] = {
        selector = {pos = Vector(0, 0, 0), ang = Angle(0, 0, -37)}
    },
    [2] = {
        selector = {pos = Vector(0, 0, 0), ang = Angle(0, 0, -73)}
    },
}
