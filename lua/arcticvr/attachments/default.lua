...
att.AttThink = function(swep, vm, attmdl, attslot)
    -- use this to add per tick behaviour such as changing the appearance based on weapon state
end

att.AttachFunc = function(SWEP) end
att.DetachFunc = function(SWEP) end