...
concommand.Add("arcticvr_printmats", function(ply) PrintTable(ply:GetViewModel():GetMaterials()) end)
concommand.Add("arcticvr_printgvr", function(ply) PrintTable(g_VR) end)
CreateClientConVar("arcticvr_2h_sens", "0.5")
CreateClientConVar("arcticvr_virtualstock", "1")
CreateClientConVar("arcticvr_headpouch", "0")
CreateClientConVar("arcticvr_hybridpouch", "1")
...
CreateClientConVar("arcticvr_hybridpouchdist", "12.5")
